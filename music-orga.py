...
UTILISATION :
  ...
  python3 music-orga.py /home/papaours/Musique --dry-run --log Musiques.md

  # Exécution réelle :
  python3 music-orga.py /home/papaours/Musique

  python3 music-orga.py /home/papaours/Musique --log Musiques.md
