...
#  pour Beartify (proxifié par Caddy sur /api/translate, port local 3005).
#
...
#   2) Déploie libretranslate/libretranslate, lié UNIQUEMENT à 127.0.0.1:3005
...
HOST_PORT="3005"               # doit correspondre à (libretranslate_proxy) dans le Caddyfile
...
# ── 2. Libérer le port 3005, peu importe QUI l'occupe ──────────────────────
